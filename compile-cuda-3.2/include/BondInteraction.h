...
static __device__ void HarmonicSpring::
force (const ScalorType * param,
       ScalorType diffx,
       ScalorType diffy,
       ScalorType diffz,
...
static __device__ ScalorType FENE::
forcePoten (const ScalorType * param,
	    ScalorType diffx,
	    ScalorType diffy,
	    ScalorType diffz,
...
static __device__ ScalorType FENE2::
forcePoten (const ScalorType * param,
	    ScalorType diffx,
	    ScalorType diffy,
	    ScalorType diffz,
