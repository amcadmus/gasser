...
__device__ void angleForce0 (const mdBondInteraction_t ftype,
			     ScalorType * param,
...
__device__ void angleForcePoten0 (const mdBondInteraction_t ftype,
				  ScalorType * param,
				  const ScalorType diff0x,
				  const ScalorType diff0y,
				  const ScalorType diff0z,
...
__device__ void angleForce1 (const mdBondInteraction_t ftype,
			     ScalorType * param,
			     const ScalorType diff0x,
			     const ScalorType diff0y,
			     const ScalorType diff0z,
...
__device__ void angleForcePoten1 (const mdBondInteraction_t ftype,
				  ScalorType * param,
				  const ScalorType diff0x,
				  const ScalorType diff0y,
				  const ScalorType diff0z,
				      ...
				      ScalorType * f1z)
{
  ...
  *f0x = scalor * (diff1x - c01 * sqrtc00i * sqrtc00i * diff0x - diff0x + c01 * sqrtc11i * sqrtc11i * diff1x);
  *f0y = scalor * (diff1y - c01 * sqrtc00i * sqrtc00i * diff0y - diff0y + c01 * sqrtc11i * sqrtc11i * diff1y);
  *f0z = scalor * (diff1z - c01 * sqrtc00i * sqrtc00i * diff0z - diff0z + c01 * sqrtc11i * sqrtc11i * diff1z);
}
