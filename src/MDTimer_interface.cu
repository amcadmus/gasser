...
void MDTimer::printRecord (FILE * fp)
{
  ...
  fprintf(fp, "Others uncounted:                    %1.3es   (% 3.1f%)\n",
	  0.001 * otherTime,
	  100 * otherTime / timeRecord[mdTimeTotal]);
  fprintf(fp, "Total time:                          %1.3es   (% 3.1f%)\n",
