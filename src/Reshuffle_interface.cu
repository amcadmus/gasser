...
// 		sizeof(IndexType) * sys.bdlist.dbdlist.stride * sys.bdlist.dbdlist.maxNumBond);
//     cudaMalloc ((void**)&bkBondListBondIndex, 
// 		sizeof(ForceIndexType) * sys.bdlist.dbdlist.stride * sys.bdlist.dbdlist.maxNumBond);
...
// 	<<<atomGridDim, myBlockDim>>> (
// 	    sys.ddata.numAtom,
// 	    sys.bdlist.dbdlist.bondNeighborIndex, 
// 	    sys.bdlist.dbdlist.bondIndex, 
// 	    sys.bdlist.dbdlist.numBond,
// 	    sys.bdlist.dbdlist.stride, 
// 	    sys.bdlist.dbdlist.maxNumBond,
// 	    bkBondListData,
// 	    bkBondListBondIndex,
// 	    bkBondListNumB);
